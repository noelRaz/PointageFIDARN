          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Liste AS/OS</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <button type="button" value="{{ $item->ext_code }}" class="suppPers dropdown-item mt-2 btn btn-danger" data-toggle="modal" data-target="#modal-supp">
                ...
                <div class="modal fade" id="modal-ajout">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <h4 class="modal-title">Nouvelle AS/OS</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="extNom" class="form-control uppercase" id="extNom" placeholder="Entrer nom" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="extPrenom" class="form-control text-capitalize" id="extPrenom" placeholder="Entrer prénom(s)" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="extEmail" class="form-control text-lowercase" id="email" placeholder="Entrer adresse e-mail" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="extTel" id="phone" required>
                                        </div>
                                            <!-- /.input group -->
                                    </div>
                                </div>
                ...
                <div class="modal" id="modifierModal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <!-- Modal Body -->
                            <form action="{{ url('updateASOS') }}" method="POST">
                                @csrf
                                @method('PUT')
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="email" class="form-control" id="emailExt" name="email">
                                </div>
                                <div class="form-group">
