          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Liste pointage AS/OS</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="ml-auto">
                        <form method="get" action="pointageFiltreExt">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">Nouvelle pointage AS/OS</h4>
                            ...
                            <form method="POST" action="addPointExt">
                                <div class="modal-body">
                                    ...
                                    @endif
                                        @csrf
                                        <div class="flex">
                                            <div class="mt-2 w-50 h-35 mr-2 bg-gray-100">
